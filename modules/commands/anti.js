...
exports.handleReply = ({
    ...
    switch (args[0]) {
        case '1':
            ...
            msg = `[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »${t.nb?'bật': 'tắt'} chống đổi tên nhóm`;
            break;
        case '3':
            t.bd = !t.bd?true: false;
            msg = `[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »${t.bd?'bật': 'tắt'} chống đổi biệt danh`;
            break;
        case '4':
            t.o = !t.o?true: false;
            msg = `[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »${t.o?'bật': 'tắt'} chống rời nhóm`;
            break;
        case '5':
            t.ato = !t.ato?true:false;
            msg = `[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »${t.ato?'bật':'tắt'} chỉ QTV nhóm/bot dùng lệnh`;
            break;
        case '6':
            t.abo = !t.abo?true:false;
            msg = `[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »${t.abo?'bật':'tắt'} chỉ QTV bot dùng lệnh`;
            break;
        default:
            msg = `[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »chưa hỗ trợ`;
            break;
    };
