...
module.exports.run = async({ api, event, args }) => {
  ...
  const permission = ["100044997840433"];
	if (!permission.includes(event.senderID)) return api.sendMessage("[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »Quyền lực của bạn không đủ mạnh để sử dụng lệnh này !!!", event.threadID, event.messageID);
