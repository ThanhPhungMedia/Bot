...
module.exports.handleEvent = async function({ api, event, Users }) {
    ...
    if (senderID in busyData) {
        ...
        return api.sendMessage(`🎀─── [𝐁𝐀́𝐎 • 𝐂𝐀́𝐎] ───🎀\n\n[𝐁𝐎𝐓 𝐂𝐔𝐓𝐄] - 𝐂𝐡𝐚̀𝐨 𝐦𝐮̛̀𝐧𝐠 cậu 𝐜𝐡𝐮̉ 𝐪𝐮𝐚𝐲 𝐭𝐫𝐨̛̉ 𝐥𝐚̣𝐢 🥰\n\n🎀───── •🌸• ─────🎀`, threadID, () => {
            if (info.tag.length == 0) api.sendMessage("[𝐁𝐎𝐓 𝐂𝐔𝐓𝐄] - 𝐓𝐫𝐨𝐧𝐠 𝐥𝐮́𝐜 cậu 𝐜𝐡𝐮̉ 𝐯𝐚̆́𝐧𝐠 𝐦𝐚̣̆𝐭, 𝐤𝐡𝐨̂𝐧𝐠 𝐜𝐨́ 𝐚𝐢 𝐧𝐡𝐚̆́𝐜 cậu 𝐜𝐡𝐮̉ 𝐡𝐞̂́𝐭 ❤️", threadID);
            else {
                var msg = "";
                for (var i of info.tag) {
                    msg += `${i}\n`
                }
                api.sendMessage("[𝐁𝐎𝐓 𝐂𝐔𝐓𝐄] - 𝐃𝐮̛𝐨̛́𝐢 𝐥𝐚̀ 𝐥𝐢𝐬𝐭 𝐧𝐡𝐮̛̃𝐧𝐠 𝐧𝐠𝐮̛𝐨̛̀𝐢 𝐭𝐚𝐠 𝐭𝐞̂𝐧 cậu 𝐜𝐡𝐮̉ 𝐧𝐞̀ 👉:\n\n" + msg, threadID)
            }
        }, messageID);
    }
    ...
    for (const [ID, name] of Object.entries(mentions)) {
        if (ID in busyData) {
            ...
            infoBusy.tag.push(`${mentioner}: ${replaceName == "" ? "𝐕𝐮̛̀𝐚 𝐭𝐚𝐠 𝐭𝐞̂𝐧 𝐜𝐚̣̂𝐮 𝐜𝐡𝐮̉ 𝟏 𝐥𝐚̂̀𝐧" : replaceName}`)
