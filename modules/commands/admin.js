...
case "sp": {
	...
	if (!permission.includes(event.senderID)) return api.sendMessage("[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »𝐐𝐮𝐲𝐞̂̀𝐧 𝐥𝐮̛̣𝐜 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐤𝐡𝐨̂𝐧𝐠 đ𝐮̉ 𝐦𝐚̣𝐧𝐡 đ𝐞̂̉ 𝐬𝐮̛̉ 𝐝𝐮̣𝐧𝐠 𝐥𝐞̣̂𝐧𝐡 𝐧𝐚̀𝐲 !!!", event.threadID, event.messageID);
        ...
        if (adminbox[threadID] == true) {
            ...
            api.sendMessage("[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »𝗧𝗮̆́𝘁 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴 𝗰𝗵𝗲̂́ 𝗱𝗼̣̂ 𝗤𝗧𝗩 𝗢𝗻𝗹𝘆", threadID, messageID);
        } else {
            adminbox[threadID] = true;
            api.sendMessage("[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »𝗕𝗮̣̂𝘁 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴 𝗰𝗵𝗲̂́ 𝗱𝗼̣̂ 𝗤𝗧𝗩 𝗢𝗻𝗹𝘆", threadID, messageID);
        }
	...
	if (!permission.includes(event.senderID)) return api.sendMessage("[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »𝐐𝐮𝐲𝐞̂̀𝐧 𝐥𝐮̛̣𝐜 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐤𝐡𝐨̂𝐧𝐠 đ𝐮̉ 𝐦𝐚̣𝐧𝐡 đ𝐞̂̉ 𝐬𝐮̛̉ 𝐝𝐮̣𝐧𝐠 𝐥𝐞̣̂𝐧𝐡 𝐧𝐚̀𝐲 !!!", event.threadID, event.messageID);
            if (config.adminOnly == false) {
                ...
                api.sendMessage(`[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »𝗕𝗮̣̂𝘁 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴 𝗰𝗵𝗶̉ 𝗔𝗱𝗺𝗶𝗻 𝗺𝗼̛́𝗶 𝗱𝘂̀𝗻𝗴 𝗱𝘂̛𝗼̛̣𝗰 𝗯𝗼𝘁`, threadID, messageID);
            } else {
                config.adminOnly = false;
                api.sendMessage(`[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »𝗧𝗮̆́𝘁 𝘁𝗵𝗮̀𝗻𝗵 𝗰𝗼̂𝗻𝗴 𝗰𝗵𝗶̉ 𝗔𝗱𝗺𝗶𝗻 𝗺𝗼̛́𝗶 𝗱𝘂̀𝗻𝗴 𝗱𝘂̛𝗼̛̣𝗰 𝗯𝗼𝘁`, threadID, messageID);
            }
                writeFileSync(configPath, JSON.stringify(config, null, 4), 'utf8');
                break;
              }
	...
	if (!permission.includes(event.senderID)) return api.sendMessage("[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »𝐐𝐮𝐲𝐞̂̀𝐧 𝐥𝐮̛̣𝐜 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐤𝐡𝐨̂𝐧𝐠 đ𝐮̉ 𝐦𝐚̣𝐧𝐡 đ𝐞̂̉ 𝐬𝐮̛̉ 𝐝𝐮̣𝐧𝐠 𝐥𝐞̣̂𝐧𝐡 𝐧𝐚̀𝐲 !!!", event.threadID, event.messageID);
            if (config.adminPaseOnly == false) {
                ...
                api.sendMessage(`[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »Bật thành công chỉ 𝗔𝗱𝗺𝗶𝗻 or 𝗡𝗴𝘂̛𝗼̛̀𝗶 𝗧𝗵𝘂𝗲̂ 𝗕𝗼𝘁 mới nhắn riêng với bot được`, threadID, messageID);
            } else {
                config.adminPaseOnly = false;
                api.sendMessage(`[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »Tắt thành công chỉ 𝗔𝗱𝗺𝗶𝗻 or 𝗡𝗴𝘂̛𝗼̛̀𝗶 𝗧𝗵𝘂𝗲̂ 𝗕𝗼𝘁 mới nhắn riêng với bot được`, threadID, messageID);
            }
                writeFileSync(configPath, JSON.stringify(config, null, 4), 'utf8');
                break;
							}
	...
	if (!permission.includes(event.senderID)) return api.sendMessage("[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »𝐐𝐮𝐲𝐞̂̀𝐧 𝐥𝐮̛̣𝐜 𝐜𝐮̉𝐚 𝐛𝐚̣𝐧 𝐤𝐡𝐨̂𝐧𝐠 đ𝐮̉ 𝐦𝐚̣𝐧𝐡 đ𝐞̂̉ 𝐬𝐮̛̉ 𝐝𝐮̣𝐧𝐠 𝐥𝐞̣̂𝐧𝐡 𝐧𝐚̀𝐲!!!", event.threadID, event.messageID);
            if (config.ndhOnly == false) {
                config.ndhOnly = true;
                api.sendMessage(`[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »Bật thành công chỉ 𝗔𝗱𝗺𝗶𝗻 or 𝗡𝗴𝘂̛𝗼̛̀𝗶 𝗧𝗵𝘂𝗲̂ 𝗕𝗼𝘁 mới dùng được bot`, threadID, messageID);
            } else {
                config.ndhOnly = false;
                api.sendMessage(`[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »Tắt thành công chỉ 𝗔𝗱𝗺𝗶𝗻 or 𝗡𝗴𝘂̛𝗼̛̀𝗶 𝗧𝗵𝘂𝗲̂ 𝗕𝗼𝘁 mới dùng được bot`, threadID, messageID);
            }
                writeFileSync(configPath, JSON.stringify(config, null, 4), 'utf8');
                break;
							}
