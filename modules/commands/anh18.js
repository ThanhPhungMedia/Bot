...
var min = Math.floor(Math.random() * 1);
  ...
  var money = data.money
      if(money < 10) api.sendMessage("𝟏𝟎$ 𝐧𝐡𝐚 𝐛𝐚̣𝐧 𝐲𝐞̂𝐮",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 10})
   var callback = () => api.sendMessage({body:`𝐌𝐨̂𝐧𝐠 𝐝𝐮́ 𝐜𝐮̉𝐚 𝐜𝐚́𝐜 𝐜𝐨𝐧 𝐯𝐨̛̣ đ𝐚̂𝐲`,attachment: fs.createReadStream(__dirname + "/cache/1.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/1.jpg"), event.messageID); 
