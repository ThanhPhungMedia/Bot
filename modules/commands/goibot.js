...
module.exports.handleEvent = function({ api, event }) {
  ...
  if ((event.body.toLowerCase() == "ừ") || (event.body.toLowerCase() == "u")) {
    return api.sendMessage("𝗨̛̀ 𝗮̀ 𝗯𝗶𝗲̂́𝘁 𝗱𝗮̣ 𝗸𝗵𝗼̂𝗻𝗴? 𝗹𝗮́𝗼 𝗮̀:)))", threadID);
  };

  if ((event.body.toLowerCase() == "ừa") || (event.body.toLowerCase() == "ua")) {
    return api.sendMessage("𝗨̛̀a 𝗮̀ 𝗯𝗶𝗲̂́𝘁 𝗱𝗮̣ 𝗸𝗵𝗼̂𝗻𝗴? 𝗹𝗮́𝗼 𝗮̀ :)))", threadID);
  };
  ...
  if ((event.body.toLowerCase() == "dạ") || (event.body.toLowerCase() == "da")) {
    return api.sendMessage("𝗡𝗴𝗼𝗮𝗻 đ𝗮̂́𝘆 đ𝗼̛̣𝗶 𝗮𝗻𝗵 𝗵𝗶𝗲̂́𝘂 𝗻𝗴𝘂̉ 𝗱𝗮̣̂𝘆 𝗽𝗵𝗮́𝘁 𝗻𝗴𝘂̛𝗼̛̀𝗶 𝘆𝗲̂𝘂 𝗰𝗵𝗼 𝗻𝗵𝗲́", threadID);
  };
 ...
 if ((event.body.toLowerCase() == "bsvv nha mn") || (event.body.toLowerCase() == "bsvv nha mn")) {
  ...
  if ((event.body.toLowerCase() == "tg") || (event.body.toLowerCase() == "tvm")) {
    return api.sendMessage("[𝘽𝙊𝙏 𝙍𝙮𝙤🎀] »Chào bạn vào show ảnh giới thiệu set biệt danh giúp mình nhé cảm ơn mãi iu\n𝑼𝑫𝑻•tên + năm sinh + nơi ở", threadID);
  };
